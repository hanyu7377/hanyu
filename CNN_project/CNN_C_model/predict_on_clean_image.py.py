...
#plt.title('C-model prediction on clean images',y=1.1,fontsize = 30)
#plt.savefig("../C_model_result/C model prediction on clean images",dpi = 800,bbox_inches = 'tight')
plt.title('M-model prediction on clean images',y=1.1,fontsize = 30)
plt.savefig("../M_model_result/M model prediction on clean images",dpi = 800,bbox_inches = 'tight')
plt.show()
...
for i, index in enumerate(misclassified_indices):
    ...
    ax.set_title(f'True: {true_label}\nPredicted: {predicted_label}',fontsize = 30)
    ax.axis('off')
