...
top_20_countries_data_2014 = df_2014['country'].value_counts().head(20)
top_20_countries_list_2014 = top_20_countries_data_2014.index.tolist()


top_20_countries_data_2015 = df_2015['country'].value_counts().head(20)
top_20_countries_list_2015 = top_20_countries_data_2015.index.tolist()
year_2014 = go.Bar(x = top_20_countries_list_2014,
                y = top_20_countries_data_2014,###列出前20名的國家
                name = "2014",
                marker = dict(color = 'rgba(255, 165, 0, 1)',###第四個數字是透明度
                line=dict(color='rgb(0,0,0)',width=2.0)),) ###控制box框的顏色 0,0,0代表黑色
year_2015 = go.Bar(x = top_20_countries_list_2015,
                y = top_20_countries_data_2015,
                name = "2015",
...
fig.write_html("bar_chart.html")####以html的格式儲存
fig.show()
